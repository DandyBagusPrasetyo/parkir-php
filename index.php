            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="index.php?page=users">Users</a>
                        <a class="collapse-item" href="index.php?page=members">Members</a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Tables -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"><?php $new_page = str_replace('_', ' ', $valid_page); echo ucwords($new_page); ?></h1>

                    <div class="section-body">
                        <?php include $valid_page . '.php'; ?>
                    </div>
